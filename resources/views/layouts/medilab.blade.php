                        ...
                        <div class="col-lg-6">
                            <div class="member d-flex align-items-start">
                                ...
                                <div class="member-info">
                                    ...
                                    <p>Salam sehat guyss, saya dokter {{ $item->nama_dokter }}, Spesialis {{ $item->spesialis }}</p>
                                    <div class="social">
